...
**Phase B — Anthropic API Key Integration (3-5 days)** 3. Add optional Anthropic API key pass-through (`ANTHROPIC_API_KEY` env var):
...
**Phase C — Feature Gating (3-5 days)** 5. Gate Pro features at the function level:
...
**Phase D — Billing Backend (5-7 days)** 7. Set up Paddle (Merchant of Record) for payment processing:
